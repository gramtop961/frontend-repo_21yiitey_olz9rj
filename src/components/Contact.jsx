  ...
  return (
    <section id="contact" className="px-6 md:px-10 py-16" style={{ background: '#0a0a0a' }}>
      <div className="max-w-6xl mx-auto">
        <div className="glass glass-hover rounded-2xl p-6 md:p-8 flex flex-col md:flex-row gap-6 md:items-center md:justify-between">
          <div>
          ...
          <div className="flex flex-wrap gap-3">
            <a href="mailto:syedasrar00@outlook.com" className="px-4 py-2 rounded-lg font-semibold neon-btn">Email</a>
